...
```
recovery-rate lift positive in   19/19 scenarios   +10.3% to +58.4%   median +33.1%
value lift positive in           19/19 scenarios
wasted attempts IMPROVED in       3/19 scenarios

CONSERVATIVE HEADLINE (vs the strongest baseline):  +11.2% rate
```
